...
export const GET_PRODUCT_TO_EDIT = gql`
...
export const GET_PRODUCT_PREVIEW_LIST = gql`
  query GetProductPreviewList($options: ProductListOptions) {
    products(options: $options) {
      items {
        ...ProductForPreviewList
      }
      totalItems
    }
  }
  ${PRODUCT_FOR_PREVIEW_LIST_FRAGMENT}
`;
...
export const ASSIGN_VARIANTS_TO_CHANNEL = gql`
  mutation AssignVariantsToChannel(
...
export const REMOVE_VARIANTS_FROM_CHANNEL = gql`
  mutation RemoveVariantsFromChannel(
...
export const GET_PRODUCT_VARIANT_LIST_SIMPLE = gql`
  query GetProductVariantListSimple(
...
export const GET_PRODUCT_VARIANT_LIST_FOR_PRODUCT = gql`
  query GetProductVariantListForProduct(
    $options: ProductVariantListOptions!
    $productId: ID
  ) {
    productVariants(options: $options, productId: $productId) {
